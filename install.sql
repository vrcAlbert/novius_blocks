...
CREATE TABLE IF NOT EXISTS `novius_blocs` (
  ...
  `bloc_model` varchar(200) DEFAULT NULL,
  `bloc_model_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`bloc_id`),
  KEY `bloc_created_at` (`bloc_created_at`),
  KEY `bloc_updated_at` (`bloc_updated_at`),
  KEY `bloc_model_id` (`bloc_model_id`),
...
CREATE TABLE IF NOT EXISTS `novius_blocs_columns` (
...
CREATE TABLE IF NOT EXISTS `novius_blocs_columns_liaison` (
